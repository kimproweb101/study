...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "CodeCamp", link: "/docs/codecamp/frontend/s03.md" },
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: "ui", link: "/docs/tutorials/vue/ui.md" },
                {
                  ...
                  items: [
                    {
                      text: "unplugin-vue-router",
                      link: "/docs/tutorials/vue/plugins/unplugin-vue-router.md",
                    },
                    {
                      text: "vite-plugin-vue-layouts",
                      link: "/docs/tutorials/vue/plugins/vite-plugin-vue-layouts.md",
                    },
                  ],
                },
              ],
      ...
      "/docs/vue/": [
        {
          text: "vue",
          items: [
            { text: "설정", link: "/docs/vue/config.md" },
            { text: "basic", link: "/docs/vue/basic.md" },
            {
              ...
              items: [
                ...
                {
                  text: "AuthModalDynamic",
                  link: "/docs/vue/example/AuthModalDynamicComponent.md",
                },
                {
                  text: "boardJsonServer",
                  link: "/docs/vue/example/boardJsonServer.md",
                },
      ...
      "/docs/gym/": [
        {
          ...
          items: [
            {
              text: "시작하기",
              link: "/docs/gym/firebase-git/30_create_post.md",
            },
          ],
        },
        {
          ...
          items: [
            ...
            { text: "준비하기", link: "/docs/gym/basic/s02/s02.md" },
            {
              ...
              items: [
                {
                  text: "CompositionAPI",
                  link: "/docs/gym/basic/s03/compositionApi.md",
                },
                { text: "Setup", link: "/docs/gym/basic/s03/setupHook.md" },
                {
                  text: "템플릿 문법",
                  link: "/docs/gym/basic/s03/templateSyntax.md",
                },
                {
                  text: "반응형 기초",
                  link: "/docs/gym/basic/s03/reactivity.md",
                },
                { text: "Computed", link: "/docs/gym/basic/s03/computed.md" },
                {
                  text: "클래스&스타일 바인딩",
                  link: "/docs/gym/basic/s03/classStyleBind.md",
                },
                { text: "조건부 렌더링", link: "/docs/gym/basic/s03/if.md" },
                { text: "목록 렌더링", link: "/docs/gym/basic/s03/for.md" },
                {
                  text: "디렉티브(directives)",
                  link: "/docs/gym/basic/s03/directives.md",
                },
                { text: "이벤트 처리", link: "/docs/gym/basic/s03/event.md" },
                {
                  text: "양방향 바인딩",
                  link: "/docs/gym/basic/s03/vModel.md",
                },
                {
                  text: "Watch, WatchEffect",
                  link: "/docs/gym/basic/s03/watchWatchEffect.md",
                },
                {
                  text: "Dynamic Components",
                  link: "/docs/gym/basic/s03/dynamicComponents.md",
                },
              ],
            },
            { text: "Bootstrap5", link: "/docs/gym/basic/s05/s05.md" },
            {
              ...
              items: [
                {
                  text: "컴포넌트 기초",
                  link: "/docs/gym/basic/s06/componentBasic.md",
                },
                {
                  text: "Single File Component",
                  link: "/docs/gym/basic/s06/singgleFileComponent.md",
                },
                ...
                {
                  text: "Provide/Inject",
                  link: "/docs/gym/basic/s06/provideInject.md",
                },
                {
                  text: "LifecycleHooks",
                  link: "/docs/gym/basic/s06/lifecycleHooks.md",
                },
                {
                  text: "Template Refs",
                  link: "/docs/gym/basic/s06/templateRefs.md",
                },
                {
                  text: "script setup",
                  link: "/docs/gym/basic/s06/scriptSetup.md",
                },
                {
                  text: "동적 컴포넌트",
                  link: "/docs/gym/basic/s06/dynamicComponent.md",
                },
      ...
      "/docs/codecamp/": [
        {
          text: "FrontEnd",
          items: [
            { text: "section03", link: "/docs/codecamp/frontend/s03.md" },
          ],
        },
      ],
    },
